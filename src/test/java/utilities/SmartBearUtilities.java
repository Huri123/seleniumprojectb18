...
public class SmartBearUtilities {
    ...
    public static void login(WebDriver driver) {  //static yaptik cunku o zaman object olusturabiliriz. //static because We can call through class
    ...
    public static void verifyOrder(WebDriver driver, String name) {
        ...
        for (WebElement each : namesList) {
            if (each.getText().equals(name)) {
                ...
                return;  //break demedik. cunku o breaks the loop.but return tum loop u aclistirir.
            }
        }
