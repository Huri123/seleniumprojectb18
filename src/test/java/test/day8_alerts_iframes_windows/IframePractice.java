...
public class IframePractice {
    ...
    public void iframe_practice_test() {
        ...
        //switching to iframe using webElement                       //1.yol
        //driver.switchTo().frame(iframe);

        //switching to iframe using indexes                         //2.yol
        //driver.switchTo().frame(0);

        //switching to iframe using id or name attribute value    //3.yol
        ...
        driver.switchTo().parentFrame();         //will switch back to the parent frame ==> 1. yol
        //driver.switchTo().defaultContent();    //will switch back to the default frame ==> 2. yol
