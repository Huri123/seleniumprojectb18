...
public class Dropdowns_Intro {
    ...
    WebDriver driver; //boyle instance yaptik in the class level diger methodlarda da kullanalim diye
    ...
    public void setUp(){
        ...
        //WebDriver driver = WebDriverFactory.getDriver("chrome"); //boyle yaparsak local variable olur.diger methodlarda kullanamayiz
         driver = WebDriverFactory.getDriver("chrome");
        driver.get("http://practice.cybertekschool.com/dropdown");
        driver.manage().window().maximize();
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
    }
    @AfterMethod  //bunun order i onemli degil. cunku compile checks annotation first.
    ...
    public void test1_default_value_verification() {
        ...
        String actualDefaultOfSimpleDropdown = simpleDropDown.getFirstSelectedOption().getText(); //String e assign yapacagimiz icin getText olmak zorunda
        ...
        //getText() String e donusturuyor
        String expectedDefaultOfStateDropdown = "State selection";
    ...
    public void test2_state_dropdown_verification() throws InterruptedException{
        ...
        Thread.sleep(1000);
        stateDropdown.selectByVisibleText("Virginia"); //dropdown i tikladiginda hangileri cikiyorsa o selectbyvisibletext dir.
        ...
        //Select a State i 0. index diye saydik.bunu inspectten degil dropdowni acip 0,1,2,3 diye index sayarak yaptik

        //6. Verify final selected option is California.

        String expectedOption = "California";
        String actualSelectedOption = stateDropdown.getFirstSelectedOption().getText();
        //getFirstSelectedOption() bu hangisi seciliyse onu getirir
