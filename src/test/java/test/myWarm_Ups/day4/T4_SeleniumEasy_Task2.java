...
public class T4_SeleniumEasy_Task2 {
    ...
    public static void main(String[] args) {
        ...
        String actualText = checkAllButton.getAttribute("value"); //cunku inspect te text i bulamadik. text karsiligi value idi
        ...
        String actualButtonAfterClick = checkAllButton.getAttribute("value");
        String expectedValueAfterClick = "Uncheck All";

        if (actualButtonAfterClick.equals(expectedValueAfterClick)) {
