package test.day4_findElements_chechbox_radio;
...
public class P01_MeriamWebster_FindElements {
    ...
    public static void main(String[] args) {
        ...
        driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS); //Bu java daki threat.sleep() gibi islem gorur.tek fark page yuklendikten sonra saniyeleri devam etmek zorunda degil
